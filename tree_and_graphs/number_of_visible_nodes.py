...
def get_depth(this_node: TreeNode) -> int:
    depth_left = 0 if this_node.left is None else get_depth(this_node.left)
    depth_right = 0 if this_node.right is None else get_depth(this_node.right)
