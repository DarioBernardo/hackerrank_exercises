...
def countDistinctTriangles(arr):
    ...
    for triangle in arr:
        sorted_vertexes = sorted(triangle)
        triagle_hash = "<{}-{}-{}>".format(sorted_vertexes[0], sorted_vertexes[1], sorted_vertexes[2])
        unique_triangles.add(triagle_hash)
...
if __name__ == "__main__":
    ...
    arr_2 = [(1, 2, 3), (3, 2, 1), (6, 9, 10), (7, 7, 7)]
    expected_2 = 3
    output_2 = countDistinctTriangles(arr_2)
    check(expected_2, output_2)
